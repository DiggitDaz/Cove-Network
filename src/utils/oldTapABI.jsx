export const oldTapABI = [
      ...
      inputs: [
        { internalType: 'address[]', name: 'UserAddresses', type: 'address[]' },
        {
          components: [
            ...
            { internalType: 'address', name: 'entered_address', type: 'address' },
          ],
    ...
    },
    {
      inputs: [
        ...
        { internalType: 'address', name: '_BR34PTokenAddress', type: 'address' },
        { internalType: 'address', name: '_dripTokenAddress', type: 'address' },
    ...
    {
      inputs: [
        { internalType: 'uint256', name: 'newTotalAirdrop', type: 'uint256' },
      ],
    ...
    {
      inputs: [{ internalType: 'uint256', name: 'newTotalBNB', type: 'uint256' }],
      name: 'setTotalBNB',
      outputs: [],
      stateMutability: 'nonpayable',
      type: 'function',
    ...
    {
      inputs: [{ internalType: 'uint256', name: 'newTotalTX', type: 'uint256' }],
      name: 'setTotalTX',
      outputs: [],
      stateMutability: 'nonpayable',
      type: 'function',
    ...
    {
      inputs: [
        { internalType: 'uint256', name: 'newTotalUsers', type: 'uint256' },
      ],
      name: 'setTotalUsers',
      outputs: [],
      stateMutability: 'nonpayable',
    ...
    {
      inputs: [
        { internalType: 'uint256', name: 'newTotalWithdraw', type: 'uint256' },
      ],
